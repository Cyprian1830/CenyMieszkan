...
from src.zajecia04.operations import Incident, IncidentQueue
from src.zajecia04.personnel import Driver
...
def run_application():
    ...
    # driver2 = Driver("Anna", "Brown", 126, 11500.0, "DL12346", ["ALSO", "PHTLS"])
